...
$department = $_SESSION['data']['dep'] ?? NULL;
...
<body>
	...
	<div class="breadcrumbs"> <!-- breadcrumbs begin -->
		...
		<div class="container">
			...
			<span>\</span>
			<a class="active" href="add_patient.php">Thêm Phòng Khám</a>
    ...
    <div class="add-patient"> <!-- add-patient begin -->
        ...
        <div class="container">
            <div class="form-add-patient"> <!-- form-add-patient begin -->
                ...
                <form id="form-add-patient" method="post" action="?controller=Clinic&action=addClinic">
                    
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>Tên Phòng Khám</label> <span style="color: red;">*</span>
                            <input class="form-control" type="text" placeholder="Tên Phòng Khám" name="cli_name" value="<?=$name?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control gender" style="cursor: pointer;" name="cli_dep">
                                ...
                                <?php $i = 0; foreach ($dep as $value) { ?>
                                    <option <?php if($dep == $value['dep_code']) echo 'selected' ?> value="<?= $value['dep_code'] ?>" > <?=$value['dep_name']?> </option>
                                <?php $i++; }  ?>
                            </select>
                    ...
                    <button type="submit" class="btn" name="add-clinic">Thêm Phòng Khám</button>	
