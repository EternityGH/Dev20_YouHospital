...
<body>
	...
	<div class="breadcrumbs"> <!-- breadcrumbs begin -->
		...
		<div class="container">
			...
			<span>\</span>
			<a class="active" href="?controller=Medicine&action=getViewAdd">Sửa Thông Tin Thuốc</a>
	...
	<div class="add-patient add-medicine"> <!-- add-medicine begin -->
		...
		<div class="title"> <!-- title begin -->
			...
			<h4>Sửa Thông Tin Thuốc</h4>

		</div> <!-- title finish -->
		<div class="container">
			<div class="form-add-patient form-add-medicine"> <!-- form-add-medicine begin -->

				<form method="post" action="?controller=Medicine&action=editMedicine">
					<input name="med_code" hidden value="<?=$med['med_code']?>">

					<div class="form-group">
						<label>Tên thuốc</label> <span style="color: red">*</span>
						<input class="form-control" type="text" name="med_name" placeholder="Tên thuốc" value="<?=$med['med_name']?>">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="med_type" placeholder="Đơn vị tính" value="<?=$med['med_type']?>">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="med_num" placeholder="Số lượng" value="<?=$med['med_num']?>">
						<i class="fab fa-pied-piper-hat"></i>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="med_price" placeholder="Giá bán" value="<?=$med['med_price']?>">
					...
					<div class="form-group">
						...
						<select name="med_group" class="form-control med-group" style="cursor: pointer;" >
							<option disabled="disabled">Nhóm thuốc</option>
							<?php 
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="med_tut" placeholder="Cách dùng" value="<?=$med['med_tut']?>">
						<i class="fab fa-pied-piper-hat"></i>
						...
						<button type="submit" class="btn" name="edit-medicine">Sửa</button>	
	...
	<style>	
		div.add-patient div.form-add-patient form i {
			font-size: 12px;
			right: 20px;
		}
	</style>
    ...
    <script type="text/javascript">
		$(function() {
            $('.form-add-patient select.med-group').selectmenu();
		});
	</script>
</body>
<?php
