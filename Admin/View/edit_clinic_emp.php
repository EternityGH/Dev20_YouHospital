...
<body>
    ...
    <div class="add-patient"> <!-- edit-patient begin -->
        ...
        <div class="container">
            <div class="form-add-patient"> <!-- form-add-patient begin -->
                ...
                <form id="form-add-patient" method="post" action="?controller=ClinicEmp&action=editClinic_emp&id=<?=$cli['clin_id']?>">
                    
                    
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>Mã Nhân Viên</label> <span style="color: red;">*</span>
                            <input class="form-control" type="text" placeholder="Mã Nhân Viên" name="clin_emp_code" value="<?=$cli['emp_code']?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control gender" style="cursor: pointer;" name="clin_dep_code">
                                
                                <option disabled="disabled" selected="selected">Phòng Khám</option>
                                <?php  foreach ($cli_roo as $value) { ?>
                               
                                <option <?php if($cli['cli_id'] == $value['cli_id']) echo 'selected' ?> value="<?=$value['cli_id'] ?>" > <?=$value['cli_name']?> </option>
                                <?php }  ?>
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="date" placeholder="Ngày Khám" name="clin_date" value="<?=$cli['clin_date']?>">
                            <i class="fas fa-user"></i>
